...
/**
 * Servlet implementation class NoticeUserNextServlet
 */
@WebServlet("/nunext")
public class NoticeUserNextServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NoticeUserNextServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(noticeNext > noticeNo) {
			response.sendRedirect("/math/nudetail?no="+noticeNext);
		}else {

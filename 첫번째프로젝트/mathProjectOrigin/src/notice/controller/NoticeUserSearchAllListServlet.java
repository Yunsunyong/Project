...
/**
 * Servlet implementation class NoticeUserSearchAllListServlet
 */
@WebServlet("/nuslist")
public class NoticeUserSearchAllListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NoticeUserSearchAllListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(nsList.size() > 0 || nsList.size() == 0) {
			view = request.getRequestDispatcher("views/notice/noticeUserListView.jsp");

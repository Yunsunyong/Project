...
/**
 * Servlet implementation class CourseUserListServlet
 */
@WebServlet("/culist")
public class CourseUserListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CourseUserListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Book> bList = cservice.bookList(sOption);

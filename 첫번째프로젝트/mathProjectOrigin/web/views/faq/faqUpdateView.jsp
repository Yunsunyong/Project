...
<!-- css -->
  ...
  <link href="/math/resources/assets/css/faq/faqUpdateView.css" rel="stylesheet" />
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> <%=faq.getFaqNo() %>번 수정페이지</p>
                </div>
                <div class="card-body">
...
<tr>
	...
	<tr>
		<th>제목</th>
		<td><input type="text"  id="title" name="title"  value="<%=faq.getQuestionContent() %>" class="form-control"></td>
	</tr>
	<tr>
		<th>내용</th>

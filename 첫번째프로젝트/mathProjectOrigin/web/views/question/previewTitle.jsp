...
<!-- css -->
	<link href="/math/resources/assets/css/question/previewTitle.css" rel="stylesheet" />
...
for(int i=0; i<4; i++){
   ...
   if(i == strArr.length - 1 && (1 == strArr.length % 4)){
       out.println("<div class='p'></div>"); 
       out.println("<div class='p'></div>");
       out.println("<div class='p'></div>");
       break;
    }else if(i == strArr.length - 1 && (2 == strArr.length % 4)){
       out.println("<div class='p'></div>"); 
       out.println("<div class='p'></div>");
       break;
    }else if(i == strArr.length - 1 && (3 == strArr.length % 4)){
       out.println("<div class='p'></div>");
       break;
    }
}

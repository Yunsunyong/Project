...
CREATE TABLE TB_PERMISSION (
    USER_ID VARCHAR2(50),
    MIDDLE_FONE CHAR(1) DEFAULT 'N',
    MIDDLE_FTWO CHAR(1) DEFAULT 'N',
    MIDDLE_SONE CHAR(1) DEFAULT 'N',
    MIDDLE_STWO CHAR(1) DEFAULT 'N',
    MIDDLE_TONE CHAR(1) DEFAULT 'N',
    MIDDLE_TTWO CHAR(1) DEFAULT 'N',
    HIGH_FONE CHAR(1) DEFAULT 'N',
    HIGH_FTWO CHAR(1) DEFAULT 'N',
    HIGH_SONE CHAR(1) DEFAULT 'N',
    HIGH_STWO CHAR(1) DEFAULT 'N',
    HIGH_TONE CHAR(1) DEFAULT 'N',
    HIGH_TTWO CHAR(1) DEFAULT 'N'
); 
...
COMMENT ON COLUMN TB_PERMISSION.MIDDLE_FONE IS '중1-1';
COMMENT ON COLUMN TB_PERMISSION.MIDDLE_FTWO IS '중1-2';
COMMENT ON COLUMN TB_PERMISSION.MIDDLE_SONE IS '중2-1';
COMMENT ON COLUMN TB_PERMISSION.MIDDLE_STWO IS '중2-2';
COMMENT ON COLUMN TB_PERMISSION.MIDDLE_TONE IS '중3-1';
COMMENT ON COLUMN TB_PERMISSION.MIDDLE_TTWO IS '중3-2';
COMMENT ON COLUMN TB_PERMISSION.HIGH_FONE IS '고1-1';
COMMENT ON COLUMN TB_PERMISSION.HIGH_FTWO IS '고1-2';
COMMENT ON COLUMN TB_PERMISSION.HIGH_SONE IS '고2-1';
COMMENT ON COLUMN TB_PERMISSION.HIGH_STWO IS '고2-2';
COMMENT ON COLUMN TB_PERMISSION.HIGH_TONE IS '고3-1';
COMMENT ON COLUMN TB_PERMISSION.HIGH_TTWO IS '고3-2';

INSERT INTO TB_PERMISSION 
VALUES ('ysy4139@gmail.com',DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT);
INSERT INTO TB_PERMISSION 
VALUES ('dlvkvk2000@gmail.com',DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT);
INSERT INTO TB_PERMISSION 
VALUES ('tomoh88.wiki@gmail.com',DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT);
INSERT INTO TB_PERMISSION 
VALUES ('aftersay3@gmail.com',DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT);
INSERT INTO TB_PERMISSION 
VALUES ('yswpg1204@naver.com',DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT);
INSERT INTO TB_PERMISSION 
VALUES ('drumhyo@hanmail.net',DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT);

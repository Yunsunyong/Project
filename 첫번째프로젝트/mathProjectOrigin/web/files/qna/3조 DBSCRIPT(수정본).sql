...
INSERT INTO TB_USER
VALUES ('ysy4139@gmail.com','pass01','윤선용','010-2530-6563',DEFAULT,DEFAULT,DEFAULT);
INSERT INTO TB_USER
VALUES ('dlvkvk2000@gmail.com','pass02','이하늘','010-9959-0214',DEFAULT,DEFAULT,DEFAULT);
INSERT INTO TB_USER
VALUES ('tomoh88.wiki@gmail.com','pass03','김지훈','010-9767-2467',DEFAULT,DEFAULT,DEFAULT);
INSERT INTO TB_USER
VALUES ('aftersay3@gmail.com','pass04','이재경','010-1111-1111',DEFAULT,DEFAULT,DEFAULT);
INSERT INTO TB_USER
VALUES ('yswpg1204@naver.com','pass05','하종은','010-7448-8459',DEFAULT,DEFAULT,DEFAULT);
INSERT INTO TB_USER
...
VALUES (SQ_NOTINO.NEXTVAL, '첫번째점검', '오늘 점검이 있으니 홈페이지 사용은 자제해주세요.1', DEFAULT, 0,' ',' ', 'admin01');
INSERT INTO TB_NOTICE
...
CREATE TABLE TB_PERMISSION (
    USER_ID VARCHAR2(50),
    중1_1 CHAR(1) DEFAULT 'N',
    중1_2 CHAR(1) DEFAULT 'N',
    중2_1 CHAR(1) DEFAULT 'N',
    중2_2 CHAR(1) DEFAULT 'N',
    중3_1 CHAR(1) DEFAULT 'N',
    중3_2 CHAR(1) DEFAULT 'N',
    고1_1 CHAR(1) DEFAULT 'N',
    고1_2 CHAR(1) DEFAULT 'N',
    고2_1 CHAR(1) DEFAULT 'N',
    고2_2 CHAR(1) DEFAULT 'N',
    고3_1 CHAR(1) DEFAULT 'N',
    고3_2 CHAR(1) DEFAULT 'N'
); 
...
COMMENT ON COLUMN TB_PERMISSION.중1_1 IS '중1-1';
COMMENT ON COLUMN TB_PERMISSION.중1_2 IS '중1-2';
COMMENT ON COLUMN TB_PERMISSION.중2_1 IS '중2-1';
COMMENT ON COLUMN TB_PERMISSION.중2_2 IS '중2-2';
COMMENT ON COLUMN TB_PERMISSION.중3_1 IS '중3-1';
COMMENT ON COLUMN TB_PERMISSION.중3_2 IS '중3-2';
COMMENT ON COLUMN TB_PERMISSION.고1_1 IS '고1-1';
COMMENT ON COLUMN TB_PERMISSION.고1_2 IS '고1-2';
COMMENT ON COLUMN TB_PERMISSION.고2_1 IS '고2-1';
COMMENT ON COLUMN TB_PERMISSION.고2_2 IS '고2-2';
COMMENT ON COLUMN TB_PERMISSION.고3_1 IS '고3-1';
COMMENT ON COLUMN TB_PERMISSION.고3_2 IS '고3-2';
